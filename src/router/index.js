...
export const constantRoutes = [
...

  {
    ...
    component: Layout,
    redirect: '/hospitalSettings/list',
    name: '医院设置信息管理',
    ...
    children: [
      {
        path: 'list',
        name: '医院设置信息列表',
        component: () => import('@/views/hospital-settings/list'),
        meta: { title: '医院设置信息列表', icon: 'table' }
      },
      {
        path: 'add',
        name: '添加医院设置信息',
        component: () => import('@/views/hospital-settings/add'),
        meta: { title: '医院设置信息添加', icon: 'tree' }
      },
      {
        path: 'edit/:id',
        name: '修改医院设置信息',
  ...
  },
  {
    ...
    name: '数据管理',
    meta: { title: '数据管理管理', icon: 'el-icon-s-help' },
    alwaysShow: true,
    children: [
      {
        path: 'dictionary',
